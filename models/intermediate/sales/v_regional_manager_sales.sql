...
SELECT
	...
	s.CONTRACT_DATE,
	s.CLOSE_DATE,
    CASE WHEN UPPER(s.STATUS) = 'CLOSED' THEN 1 ELSE 0 END IsClosed,
    CASE WHEN UPPER(s.STATUS) = 'UNDER CONTRACT' THEN 1 ELSE 0 END IsUnderContract,
    CASE WHEN UPPER(s.STATUS) = 'CANCELLED' THEN 1 ELSE 0 END IsCancelled,
    s.DAYS_TO_CLOSE,
	s.STATUS,
	s.BUYER_SOURCE,
	s.AGENT_COMMISSION,
